...
export const HANDLER_CYLES: Record<HandlerTypes, IStepDefinition[]> = {
  ...
  [HandlerTypes.SEARCH]: [
    ...
    new Hook(HookFunctionTypes.onBeforeSearch),
    new Event(HookFunctionTypes.onBeforeSearch),
    new Phase("search.query", Search.FetchPhase),
    new Phase("search.relational", List.RelationalPhase),
    new Hook(HookFunctionTypes.onAfterSearch),
    new Event(HookFunctionTypes.onAfterSearch),
  ...
  [HandlerTypes.PATCH]: [
    ...
    new Hook(HookFunctionTypes.onBeforePatchQuery),
    new Event(HookFunctionTypes.onBeforePatchQuery),
    new Phase("patch.query", Single.GetPhase),
    new Hook(HookFunctionTypes.onAfterPatchQuery),
    new Event(HookFunctionTypes.onAfterPatchQuery),
    new Phase("patch.prepareAction", Patch.PrepareActionPhase),
    new Hook(HookFunctionTypes.onBeforePatch),
    new Event(HookFunctionTypes.onBeforePatch),
    new Phase("patch.action", Update.ActionPhase),
    new Hook(HookFunctionTypes.onAfterPatch),
    new Event(HookFunctionTypes.onAfterPatch),
  ...
  [HandlerTypes.ALL]: [
    ...
    new Hook(HookFunctionTypes.onBeforeAll),
    new Event(HookFunctionTypes.onBeforeAll),
    new Phase("all.query", All.FetchPhase),
    new Phase("all.relational", List.RelationalPhase),
    new Hook(HookFunctionTypes.onAfterAll),
    new Event(HookFunctionTypes.onAfterAll),
